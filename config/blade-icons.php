...
return [
    ...
    */
    ...
    'sets' => [
        ...
        'default' => [
            'path' => 'resources/icons/css-icons',
            'prefix' => 'icon',
        ],
        'box' => [
            'path' => 'resources/icons/box-icons',
            'prefix' => 'box',
        ],
        'cool' => [
            'path' => 'resources/icons/cool-icons',
            'prefix' => 'cool',
        ],
        'eos' => [
            'path' => 'resources/icons/eos-icons',
            'prefix' => 'eos',
        ],
        'line' => [
            'path' => 'resources/icons/line-icons',
            'prefix' => 'line',
        ],
        'feather' => [
            'path' => 'resources/icons/feather-icons',
            'prefix' => 'feather',
        ],
        'file' => [
            'path' => 'resources/icons/file-icons',
            'prefix' => 'file',
        ],
        'hero' => [
            'path' => 'resources/icons/hero-icons',
            'prefix' => 'hero',
        ],
        'teeny' => [
            'path' => 'resources/icons/teeny-icons',
            'prefix' => 'teeny',
        ],
        'un' => [
            'path' => 'resources/icons/un-icons',
            'prefix' => 'un',
        ],
        'weather' => [
            'path' => 'resources/icons/weather-icons',
            'prefix' => 'wi',
        ],
        'health' => [
            'path' => 'resources/icons/health-icons',
            'prefix' => 'health',
        ]
    ],
