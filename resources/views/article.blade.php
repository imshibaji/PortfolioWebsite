...
<div class="flex lg:flex-row flex-col">
    {{-- <div class="lg:w-9/12 w-auto lg:px-5 lg:h-100v lg:overflow-y-scroll no-scrollbar"> --}}
    <div class="lg:w-9/12 w-auto lg:px-5">
        ...
        <div class="my-2 mb-0">{!! $post->content !!}</div>
        {{-- <div class="py-2">
            @include('tutorial.top-ads')
        </div> --}}
    </div>
    <div class="lg:w-3/12 w-auto py-5">
        ...
        <div class="px-2">
            <x-testimonials-slider limit="{{ $post->meta->review_limit ?? '3' }}" />
        </div>
        {{-- <div class="px-2">
